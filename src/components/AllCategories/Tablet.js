...
const Tablet = () => {
    ...
    return (<>
        <h2 className="inline-block text-lg font-semibold">Tablet 📱</h2> <NavLink to="/tabletpage"><button className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition duration-300 ease-in-out">View All</button></NavLink>
