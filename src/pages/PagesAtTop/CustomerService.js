    ...
    return (
        <>
            ...
            <div className='w-full h-full'>
                <div className='w-full flex justify-center md:h-96 mt-6'>
                ...
                <div className='cards flex md:gap-12 md:justify-evenly mx-2  flex-wrap'>
                    <div className='card  md:w-1/5 flex md:block'>
                        <div className='md:w-72 w-24 flex justify-center bg-[#204a86] text-white p-4'> <h1><i class="fa-solid fa-phone"></i> Call us</h1></div>
                    ...
                    <div className='card  mb-10 md:w-1/5 flex md:block'>
                        <div className='md:w-72 w-24 flex justify-center bg-[#204a86] text-white p-4'> <h1><i class="fa-brands fa-whatsapp"></i> WhatsApp us</h1></div>
                        <div className='border-slate-300 border w-72 h-72 p-6'>
                            <ul className='list-disc'>
                    ...
                    <div className='card  md:w-1/5 flex md:block'>
                        <div className='md:w-72 w-24 flex justify-center bg-[#204a86] text-white p-4'>   <h1><i class="fa-solid fa-envelope-open"></i> Email Us</h1></div>
                        <div className='border-slate-300 border w-72 h-72 p-6'>
                            <ul className='list-disc'>
                ...
                <div className='md:mx-20 md:ml-28 mx-2 mb-20'>
                    <div className=' text-[#204a86] md:text-4xl  text-xl mt-4 '>Concerns not Addressed?</div>
