    ...
    return (
        <>
            <div className='flex justify-between'>
                <div className='text-xl mt-4 font-semibold ml-24 underline'> Shipping Details <i class="fa-solid fa-truck" style={{ color: "blue" }}></i></div>
                ...
                <>
                    ...
                    <div className='mt-5 mb-96'>
                        ...
                        <div className='flex justify-center'>
                            {/* <button onClick={goToPaymentPage} className="p-5 bg-red-600 w-96 hover:bg-blue-700 text-xl text-slate-100 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mb-96 ">
                            Make Payment
                        </button> */}
                        </div>
