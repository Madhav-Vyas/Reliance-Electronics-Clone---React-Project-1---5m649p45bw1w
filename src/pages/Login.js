...
public class Main {
    ...
    public static int minBracketToremove(String str) {
        ...
        int count = 0;
        System.out.println("size now (i) " + temp.size());
        //  )(())(
        for (int i = 0; i < arr.length; i++) {
            ...
            if (arr[i] == ')' && temp.size() != 0 && temp.peek() == '(') {
                temp.pop();


            }
            else if (temp.size() == 0 && arr[i] == ')') {
                count++;
        ...
        count += temp.size();
        System.out.println("size now (iii) " + count);
    ...
    public static void main(String[] args) {
		...
		String s = "(())(((((((((";
        System.out.println("Brackets need to be removed is --> " + minBracketToremove(s));
    }

    //minimum brackets to remove for blancing 
    ...
    public static boolean isStackBalanced(String str) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            else if (temp.size() == 0 && arr[arr.length - 1] == ')') {
                return false;
            }
        }
        if (temp.size() == 0) {
